...
<!-- pemanggilan Ajax calls buat loading profile newsfeed -->
...
<script>
  ...
  $(document).ready(function() {
    ...
    //Original ajax request buat ngeload post pertama
    $.ajax({
    ...
    $(window).scroll(function() {
      var height = $('.posts_area').height(); //Div yg isinya post
      ...
      if ((document.body.scrollHeight == document.body.scrollTop + window.innerHeight) && noMorePosts == 'false') {
        ...
        var ajaxReq = $.ajax({
          ...
          success: function(response) {
            $('.posts_area').find('.nextPage').remove(); //Removes .nextpage yg skg
            $('.posts_area').find('.noMorePosts').remove(); //Removes .nextpage yg skg
