...
interface Subject{
 ...
 class OnlineStatus implements ObServer{
  private $name;
  private $subject;
  ...
  function DoUpdate() {
   echo($this->name."".$this->subject->GetSubjectStatus()."");
  }
 }
...
if(isset($_POST['post_message'])) {
 ...
 <div class="user_details column">
	...
	<div class="main_column column" id="main_column">
		<?php  
		if($user_to != "new"){
			echo "<h4>You and <a style='text-decoration: none;' href='$user_to'>" . $user_to_obj->getFirstAndLastName() . "</a></h4><hr><br>";
			...
			<form action="" method="POST">
				...
				if($user_to == "new") {
					...
					$subject = new SubjectConcrete();
					 ...
					 $subject->Add($user_to,new OnlineStatus($subject, "$user_to"));
							  
					 $subject->SetSubjectStatus(" Sedang Online");
					 $subject->Notivy();
